...
- **esp32s3-st7789-320_240-ec11**: ESP32-S3 DevKitC-1 N16R8 + 240×320 ST7789 SPI TFT + EC11 module, no touch — [breadboard wiring and editable Fritzing source](docs/boards.md#esp32s3-st7789-320_240-ec11)
- **esp32-st7735s-128_160-ec11**: same ESP32 MCU as the CYD + 1.8" 128×160 ST7735S SPI TFT + EC11, no touch, all pins aligned with the CYD — [wiring](docs/boards.md#esp32-st7735s-128_160-ec11)
...
- **JLC SZP** (立创实战派 ESP32-S3): 2.0" 320×240 ST7789 SPI TFT + FT6336 capacitive touch, 16MB flash + 8MB Octal PSRAM (`esp32s3-JLC-SZP`) — [pinout](docs/boards.md#jlc-szp-esp32-s3)

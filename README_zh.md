...
支持板型：**CYD 2432S028R**（2.8" 电阻屏）；**E32R35T**（ESP32-32E 3.5" 480×320 ST7796 电阻屏）；**EC11 旋钮最小系统**（ESP32-S3 + 240×320 ST7789 + EC11，无触摸，构建目标 `ec11_knob_minimal`）；**EC11 旋钮 ESP32 最小系统**（CYD 同款 ESP32 + 1.8" 128×160 ST7735S + EC11，无触摸，引脚对齐 CYD，构建目标 `ec11_knob_esp32`）；**JC8048W550**（Guition 5" 800×480 RGB 电容屏，ESP32-S3）。面包板接线与 Fritzing 源文件见[支持的板子](docs/boards.zh.md#ec11-旋钮最小系统)，RGB 屏排坑记录见 [docs/jc8048w550-rgb-display-guide.md](docs/jc8048w550-rgb-display-guide.md)。
